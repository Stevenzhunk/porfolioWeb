          ...
          <div className="grid grid-cols-1 gap-8 mt-8 md:mt-16 md:grid-cols-2">
              ...
              <div className="lg:flex">
                  ...
                  <div className="flex flex-col  py-6 lg:mx-6 text-white">
                      ...
                      <p className="py-8 font-light text-sm">Humedad, velocidad de viento, máxima, mínima temperatura y las temperaturas de las próximas horas.</p>
                    <div className="flex "> {/* Contenedor Iconos Git y Deploy */}
                      <a href="https://github.com/Stevenzhunk/my-weather-app" 
                         target="_blank" 
                         ...
                         <UilGithub size="2rem" className="text-white mx-auto hover:text-purpleOpc flex w-full"/>
                      </a>
                      
                      
                      <a href="https://weather-app-stvnz.s3.amazonaws.com/index.html" 
                         target="_blank" 
                         ...
                         <UilGlobe size="2rem" className="text-white mx-auto hover:text-purpleOpc flex w-full"/>
                      </a>
                    </div>
                  </div>
              </div>
              ...
              <div className="lg:flex">
                  ...
                  <div className="flex flex-col  py-6 lg:mx-6 text-white">
                      ...
                      <p className="py-8 font-light text-sm">Detalle de productos, con funciones de agregar, eliminar elementos, ver el total en el carrito, con versión móvil.</p>
                    <div className="flex "> {/* Contenedor Iconos Git y Deploy */}
                      <a href="https://github.com/Stevenzhunk/MyShoppingCart" 
                         target="_blank" 
                         className=" rounded-lg  text-base font-semibold leading-7 text-white hover:ring-gray-900/20 bg-softpurpleOpc bg-darkpurple hover:bg-white hover:text-darkpurple text-left md:text-sx flex w-full pr-0 pl-0">
                         <UilGithub size="2rem" className="text-white mx-auto hover:text-purpleOpc flex w-full"/>
                      </a>
                      ...
                      <a href="https://myshoppingcartsmartstore.s3.amazonaws.com/index.html" 
                         target="_blank" 
                         className=" rounded-lg  text-base font-semibold leading-7 text-white hover:ring-gray-900/20 bg-softpurpleOpc bg-darkpurple hover:bg-white hover:text-darkpurple text-left md:text-sx flex w-full pr-0 pl-0 ml-2">
                         <UilGlobe size="2rem" className="text-white mx-auto hover:text-purpleOpc flex w-full"/>
                      </a>
              ...
              <div className="lg:flex">
                  ...
                  <div className="flex flex-col  py-6 lg:mx-6 text-white">
                    ...
                    <div className="flex "> {/* Contenedor Iconos Git y Deploy */}
                      <a href="https://github.com/Stevenzhunk/webTrailer" 
                         target="_blank" 
                         className=" rounded-lg  text-base font-semibold leading-7 text-white hover:ring-gray-900/20 bg-softpurpleOpc bg-darkpurple hover:bg-white hover:text-darkpurple text-left md:text-sx flex w-full pr-0 pl-0">
                         <UilGithub size="2rem" className="text-white mx-auto hover:text-purpleOpc flex w-full"/>
                      </a>
                      ...
                      <a href="https://stevenzhunk-react.s3.amazonaws.com/index.html" 
                         target="_blank" 
                         className=" rounded-lg  text-base font-semibold leading-7 text-white hover:ring-gray-900/20 bg-softpurpleOpc bg-darkpurple hover:bg-white hover:text-darkpurple text-left md:text-sx flex w-full pr-0 pl-0 ml-2">
                         <UilGlobe size="2rem" className="text-white mx-auto hover:text-purpleOpc flex w-full"/>
                      </a>
              ...
              <div className="lg:flex">
                  ...
                  <div className="flex flex-col  py-6 lg:mx-6 text-white">
                    ...
                    <div className="flex "> {/* Contenedor Iconos Git y Deploy */}
                      <a href="https://github.com/Stevenzhunk/3RayGame" 
                         target="_blank" 
                         className=" rounded-lg  text-base font-semibold leading-7 text-white hover:ring-gray-900/20 bg-softpurpleOpc bg-darkpurple hover:bg-white hover:text-darkpurple text-left md:text-sx flex w-full pr-0 pl-0">
                         <UilGithub size="2rem" className="text-white mx-auto hover:text-purpleOpc flex w-full"/>
                      </a>
                      ...
                      <a href="https://stevenz-react-3enlinea.s3.amazonaws.com/index.html" 
                         target="_blank" 
                         className=" rounded-lg  text-base font-semibold leading-7 text-white hover:ring-gray-900/20 bg-softpurpleOpc bg-darkpurple hover:bg-white hover:text-darkpurple text-left md:text-sx flex w-full pr-0 pl-0 ml-2">
                         <UilGlobe size="2rem" className="text-white mx-auto hover:text-purpleOpc flex w-full"/>
                      </a>
